        ...
        <form className="space-y-4">
          <div className="flex space-x-2">
            <input
              ...
              className={`w-1/2 px-4 py-2 border rounded focus:outline-none focus:ring-2 focus:ring-blue-500 ${theme === 'dark' ? 'bg-gray-800 text-white border-gray-700' : ''}`}
            />
            <input
              type="text"
          ...
          <input
            type="email"
            placeholder="Email"
            className={`w-full px-4 py-2 border rounded focus:outline-none focus:ring-2 focus:ring-blue-500 ${theme === 'dark' ? 'bg-gray-800 text-white border-gray-700' : ''}`}
          />
          <input
            type="password"
